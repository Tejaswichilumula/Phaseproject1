...
namespace Phaseproject1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\Rainbowsdata\Teacher.txt", FileMode.Open))
            ...
            {
                List<Teacher> listTeachers = new List<Teacher>();
                string teacherfile = "C:\\Rainbowsdata\\Teacher.txt";
                ...
                File.WriteAllLines(@"C:\Rainbowsdata\Teacher.txt", arr);
            ...
            static void create()
            {
                ...
                string UIClass = "";
                string UIsection = "";
                using (FileStream fs = new FileStream(@"C:\Rainbowsdata\Teacher.txt", FileMode.Append))
